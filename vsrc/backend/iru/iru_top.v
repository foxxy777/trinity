module iru_top (
    ...
    // --- [2-wide] Pipeline Outputs for instruction 1（取消注释，统一命名 iru2isu_instr1_*） ---
    output wire                      iru2isu_instr1_valid,
    input  wire                      iru2isu_instr1_ready,
    output wire [              31:0] iru2isu_instr1_instr,
    output wire [         `PC_RANGE] iru2isu_instr1_pc,
    output wire [       `LREG_RANGE] iru2isu_instr1_lrs1,
    output wire [       `LREG_RANGE] iru2isu_instr1_lrs2,
    output wire [       `LREG_RANGE] iru2isu_instr1_lrd,
    output wire [        `SRC_RANGE] iru2isu_instr1_imm,
    output wire                      iru2isu_instr1_src1_is_reg,
    output wire                      iru2isu_instr1_src2_is_reg,
    output wire                      iru2isu_instr1_need_to_wb,
    output wire [    `CX_TYPE_RANGE] iru2isu_instr1_cx_type,
    output wire                      iru2isu_instr1_is_unsigned,
    output wire [   `ALU_TYPE_RANGE] iru2isu_instr1_alu_type,
    output wire [`MULDIV_TYPE_RANGE] iru2isu_instr1_muldiv_type,
    output wire                      iru2isu_instr1_is_word,
    output wire                      iru2isu_instr1_is_imm,
    output wire                      iru2isu_instr1_is_load,
    output wire                      iru2isu_instr1_is_store,
    output wire [               3:0] iru2isu_instr1_ls_size,
    output wire [       `PREG_RANGE] iru2isu_instr1_prs1,
    output wire [       `PREG_RANGE] iru2isu_instr1_prs2,
    output wire [       `PREG_RANGE] iru2isu_instr1_prd,
    output wire [       `PREG_RANGE] iru2isu_instr1_old_prd,
    output wire                      iru2isu_instr1_predicttaken,
    output wire [              31:0] iru2isu_instr1_predicttarget,
    ...
    rename u_rename (
        ...
        .instr1_instr               (idu2iru_instr1_instr),
        .instr1_lrs1                (idu2iru_instr1_lrs1),
        .instr1_lrs2                (idu2iru_instr1_lrs2),
        .instr1_lrd                 (idu2iru_instr1_lrd),
        .instr1_pc                  (idu2iru_instr1_pc),
        .instr1_imm                 (idu2iru_instr1_imm),
        .instr1_src1_is_reg         (idu2iru_instr1_src1_is_reg),
        .instr1_src2_is_reg         (idu2iru_instr1_src2_is_reg),
        .instr1_need_to_wb          (idu2iru_instr1_need_to_wb),
        .instr1_cx_type             (idu2iru_instr1_cx_type),
        .instr1_is_unsigned         (idu2iru_instr1_is_unsigned),
        .instr1_alu_type            (idu2iru_instr1_alu_type),
        .instr1_muldiv_type         (idu2iru_instr1_muldiv_type),
        .instr1_is_word             (idu2iru_instr1_is_word),
        .instr1_is_imm              (idu2iru_instr1_is_imm),
        .instr1_is_load             (idu2iru_instr1_is_load),
        .instr1_is_store            (idu2iru_instr1_is_store),
        .instr1_ls_size             (idu2iru_instr1_ls_size),
        .instr1_predicttaken        (idu2iru_instr1_predicttaken),
        .instr1_predicttarget       (idu2iru_instr1_predicttarget),
        /* -------------------------------- spec_rat -------------------------------- */
        //read from spec_rat
        ...
        .fl2rn_instr1prd             (fl2rn_instr1prd),  // [2-wide] freelist 第2个分配结果
        ...
        .rn2pipe_instr1_instr        (rn2pipe_instr1_instr),
        ...
        .rn2pipe_instr1_predicttaken (rn2pipe_instr1_predicttaken),
        .rn2pipe_instr1_predicttarget(rn2pipe_instr1_predicttarget),
    ...
    freelist u_freelist (
        ...
        .req1_valid        (rn2fl_instr1_lrd_valid),  // [2-wide] instr1 的 freelist 请求
        .req1_data         (fl2rn_instr1prd),  // [2-wide] freelist 分配的 第2个物理寄存器
    ...
    pipereg_autostall iru_pipereg1 (
        ...
        .muldiv_result      (64'b0),
        .opload_read_data_wb(64'b0),
        .predicttaken  (idu2iru_instr1_predicttaken),
        .predicttarget (idu2iru_instr1_predicttarget),

        .instr_valid_to_lower  (iru2isu_instr1_valid      ),
        .instr_ready_from_lower(iru2isu_instr1_ready      ),
        .lower_instr           (iru2isu_instr1_instr      ),
        .lower_pc              (iru2isu_instr1_pc         ),
        .lower_lrs1            (iru2isu_instr1_lrs1       ),
        .lower_lrs2            (iru2isu_instr1_lrs2       ),
        .lower_lrd             (iru2isu_instr1_lrd        ),
        .lower_imm             (iru2isu_instr1_imm        ),
        .lower_src1_is_reg     (iru2isu_instr1_src1_is_reg),
        .lower_src2_is_reg     (iru2isu_instr1_src2_is_reg),
        .lower_need_to_wb      (iru2isu_instr1_need_to_wb ),
        .lower_cx_type         (iru2isu_instr1_cx_type    ),
        .lower_is_unsigned     (iru2isu_instr1_is_unsigned),
        .lower_alu_type        (iru2isu_instr1_alu_type   ),
        .lower_muldiv_type     (iru2isu_instr1_muldiv_type),
        .lower_is_word         (iru2isu_instr1_is_word    ),
        .lower_is_imm          (iru2isu_instr1_is_imm     ),
        .lower_is_load         (iru2isu_instr1_is_load    ),
        .lower_is_store        (iru2isu_instr1_is_store   ),
        .lower_ls_size         (iru2isu_instr1_ls_size    ),
        .lower_prs1            (iru2isu_instr1_prs1       ),
        .lower_prs2            (iru2isu_instr1_prs2       ),
        .lower_prd             (iru2isu_instr1_prd        ),
        .lower_old_prd         (iru2isu_instr1_old_prd    ),
        .lower_predicttaken    (iru2isu_instr1_predicttaken),
        .lower_predicttarget   (iru2isu_instr1_predicttarget),
        // flush
        .flush_valid(flush_valid)
    );
